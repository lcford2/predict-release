Program multireservoir
    ...
    read(10,*)nwatershed,nnatural_flow,num_res,num_user,nfnode,ndir_inflows,nret_inflows,ndiversion,&
                nspill_flow,ninterbasin_flow,ndemand_release,nsink,ninterbasin
