...
basin = sys.argv[1]
if len(sys.argv) == 3:
    ints = sys.argv[2].lower() in ["true", "1", "y", "t", "yes"]
else:
    ints = False
...
if ints:
    ...
    tree = f"../results/basin_eval/{basin}/treed_model_no_ints/results.pickle"
    simp = f"../results/basin_eval/{basin}/simple_model_no_ints/results.pickle"
...
int_mod = "" if ints else "_no_ints"

with open(f"./basin_params/{basin}{int_mod}.json", "w") as f:
